    ...
    <div class="relative my-15">
        <div class="w-full 2xl:translate-x-20 shadow-xl rounded-2xl shadow-black/5">
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="min-w-0 flex-auto space-y-1 font-semibold">
                        <p class="text-blue-500 dark:text-blue-400 text-sm leading-6">
                ...
                <div class="space-y-2">
                    <div class="relative">
                        <div class="bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                            <div class="bg-blue-500 dark:bg-blue-400 w-1/2 h-2" role="progressbar"
                                aria-label="music progress" aria-valuenow="1456" aria-valuemin="0" aria-valuemax="4550">
                            </div>
                        </div>
                        <div
                            class="ring-blue-500 dark:ring-blue-400 ring-2 absolute left-1/2 top-1/2 w-4 h-4 -mt-2 -ml-2 flex items-center justify-center bg-white rounded-full shadow">
                            <div
                                class="w-1.5 h-1.5 bg-blue-500 dark:bg-blue-400 rounded-full ring-1 ring-inset ring-slate-900/5">
                            </div>
                        </div>
                    </div>
                    <div class="flex justify-between text-sm leading-6 font-medium tabular-nums">
                        <div class="text-blue-500 dark:text-slate-100">24:16</div>
            ...
            <div
                ...
                <button type="button"
                    class="!bg-white text-slate-900 dark:!bg-slate-500 dark:text-slate-700 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-slate-900/5 shadow-md flex items-center justify-center"
                    aria-label="Pause">
